      ...
      >
        <div className={styles.helpContainer}>
          <div className={styles.helpTitle}>
            <div style={{ fontSize: '30px', color: '#2e313c', marginBottom: '3vh' }}>使用帮助</div>
            <div style={{ textAlign: 'center' }}>按照不同身份阅读指南，帮助您快速对功能操作了如指掌</div>
          </div>
          <div style={{ width: '100%', border: 'solid 1px #eff2f6', padding: '2vw 1vw' }}>
            <div className={styles.identity}>
              <div className={styles.identityLi}>
                <img width={80} src="../../static/img/favicon.ico" alt="" />
                <Link to='/docs/doc1'>
            ...
            <div style={{ color: '#8494a6', width: '100%', textAlign: 'center', paddingTop: '2vw' }}>需要更多帮助？请致电 400-931-8118 联系我们。</div>
          </div>
        </div>
      </Layout>
